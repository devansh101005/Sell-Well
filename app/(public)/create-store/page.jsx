        ...
        try {
         ...
         if(['approved','rejected','pending'].includes(data.status)){
            ...
            switch (data.status){
                ...
                case "approved":
                    setMessage("Your store has been approved, you can now products to your own store from dashboard")
                    setTimeout(()=>router.push("/store"),5000)
                    break;

                    case "rejected":
                    setMessage("Your store has been rejected, contact the admin formore details")
                    //setTimeout(()=>router.push("/store"),5000)
                    break;
                ...
                <div className="mx-6 min-h-[70vh] my-16">
                    <form onSubmit={e => toast.promise(onSubmitHandler(e), { loading: "Submitting data..." })} className="max-w-7xl mx-auto flex flex-col items-start gap-3 text-slate-500">
                        ...
                        <div>
                            ...
                            <p className="max-w-lg">To become a seller on sell_well, submit your store details for review. Your store will be activated after admin verification.</p>
                        </div>
